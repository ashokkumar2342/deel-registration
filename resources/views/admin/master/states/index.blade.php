                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-primary"> 
                            <form action="{{ route('admin.Master.storeState') }}" method="post" class="add_form" content-refresh="state_table">
                                {{ csrf_field() }}
                                    ...
                                    @foreach ($States as $State)
                                     <tr>
                                         ...
                                         <td class="text-nowrap">
                                             <a onclick="callPopupLarge(this,'{{ route('admin.Master.editState',$State->id) }}')" title="" class="btn btn-info btn-xs"><i class="fa fa-edit"></i></a>
                                             <a href="{{ route('admin.Master.deleteState',Crypt::encrypt($State->id)) }}" onclick="return confirm('Are you sure you want to delete this item?');"  title="" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                         </td>
                                     </tr> 
                                    @endforeach
                                 </tbody>
